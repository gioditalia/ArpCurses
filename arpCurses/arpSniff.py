...
class ArpSniff():
    ...
    def __save(self):
        ...
        namefile = "%s%s.cap" % (self.savingdir,
    ...
    def __drawSaveDir(self):
        ...
        self.stdscr.addstr(self.base_Y, self.base_X+54, "D",
                           curses.color_pair(2))
        self.stdscr.refresh()
    ...
    def __drawTabContent(self):
        ...
        self.stdscr.addstr(self.base_Y+3, self.base_X+1, "F",
                           curses.color_pair(2))

        curses.textpad.rectangle(self.stdscr,
                                 self.base_Y+6, self.base_X,
                                 self.base_Y+16, self.base_X+78)

        self.stdscr.addstr(self.base_Y+6, self.base_X+1,
                           "Start/Stop(and save) sniffed packets",
                           curses.color_pair(1))

        self.stdscr.addstr(self.base_Y+6, self.base_X+1, "S",
                           curses.color_pair(2))

        # draw sniff status
        if self.sniff_status is True:
