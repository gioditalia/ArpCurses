...
class ArpNetwork():
    ...
    def __drawTabContent(self):
        ...
        curses.textpad.rectangle(self.stdscr, self.base_Y+5,self.base_X-1, self.base_Y+16, self.base_X+81)
        self.stdscr.addstr(self.base_Y+5,self.base_X+1,"Network Monitor",curses.color_pair(1))
        y = self.base_Y+6
